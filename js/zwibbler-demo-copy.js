(function() {
                ...
                return __generator(this, function(h) {
                    switch (h.label) {
                        ...
                        case 5:
                            ...
                            h.label = 6;
                        case 6:
                            return h.trys.push([6, 8, , 9]), [4, this.Cs()];
                        case 7:
                            return h.sent(), [3, 9];
                        case 8:
        ...
        Bb = function(c) {
            ...
            a.prototype.decode = function(a) {
                for (var b = [], e = 0, c = /B([^;]+);([^;]+);([^;]+);\d+;/g; e < a.length;) {
                    ...
                    if (0 === b.length) return this.log("Got change outside of batch"), null;
    ...
    var nc = function() {
        ...
        c.prototype.uo = function() {
            for (var a = this.Wo(), b = 0, d = this.lines; b < d.length; b++) {
                var e = d[b],
                    c = this.nu(e.key),
            ...
            for (var a = 0, b = 0, d = 0, e = []; a < this.da.length;) {
                switch (this.da[a]) {
                    ...
                    case c.Ac:
                        ...
                        break;
                    case c.ve:
                        e.push([c.ve, this.da[a + 3], this.da[a + 4], this.da[a + 1], this.da[a + 2], b, d]);
                        b = this.da[a + 5];
                        d = this.da[a + 6];
                        break;
                    case c.xe:
    ...
    var gd = function(c) {
        ...
        a.prototype.ia = function(a) {
            if (0 !== this.ba.text.length) {
                ...
                if (e || this.border.lineWidth) a.save(), this.Ka().Yf(a), e && (a.fillStyle = e, a.fillRect(this.Ga.x, this.Ga.y, this.Ga.width, this.Ga.height + b)), this.border.lineWidth && (a.beginPath(), a.strokeStyle = this.border.lf, a.lineWidth = this.border.lineWidth, a.rect(this.Ga.x, this.Ga.y, this.Ga.width, this.Ga.height + b), a.stroke()), a.restore();
    ...
    function vd(c) {
        ...
        function v(a, c, f, v, w, y) {
            ...
            C[1][1] = 0;
            L[0] = 0;
            for (z = L[1] = 0; z < R; z++) C[0][0] += b(D[z][0], D[z][0]), C[0][1] += b(D[z][0], D[z][1]), C[1][0] = C[0][1], C[1][1] += b(D[z][1], D[z][1]), W = 1 - v[z], Y = v[z], W = u(a[c + z], n(q(a[c], W * W * W), n(q(a[c], d(v[z])), n(q(a[f], e(v[z])), q(a[f], Y * Y * Y))))), L[0] += b(D[z][0], W), L[1] += b(D[z][1], W);
    ...
    function wd(c, a, b, d, e, h) {
        ...
        c.beginPath();
        if (f)
            for (b = (n - b) * e; b < l;) c.moveTo(0, b), c.lineTo(k, b), f = h.toString() + d, c.fillText(f, 0, b + 1 + 10), h += a, b += e * a;
        else
        ...
        Yd = function(c) {
            ...
            a.prototype.As = function(a, d, e, c) {
                for (var b = 0; b < this.active.length; b++) {
                    var h = this.active[b];
                    if (h.id === a) return h.Eb = h.tf = d, h.Fb = h.uf = e, h.dc = c, h.la = [new G(d, e)], h
                }
                this.active.push({
    ...
    var Me = function() {
        ...
        c.prototype.zn = function(a, b, d) {
            ...
            if (a && "TextNode" === a.type() || a && "PathNode" === a.type() && this.view.ga.get("allowTextInShape") || a && a.Fh()) {
                ...
                } else k = a.ja("fontName"), l = a.ja("fontSize"), n = a.ja("bold"), q = a.ja("italic");
    ...
    var Ne = x.create("MOVE"),
        Qe = function() {
            ...
            c.prototype.Cb = function(a, b, d) {
                this.ql.cancel();
                Ne("onMouseUp()");
                if (1 === this.Yj && !Oe(this.Ha.canvas.first).ed(d.pageX, d.pageY)) return Ne("Dropped nowhere!"), this.Ha.Qa(new Ie(this.Ha)), !0;
                a = "static";
                var c = 0,
                    h = 0,
                    f = 0;
    ...
    var ef = function() {
        ...
        c.prototype.$s = function() {
            for (var a = 0, b = 0; b < this.selection.length; b++) b !== a && (this.selection[a] = this.selection[b]), this.aa.yd(this.selection[a].id) && (a += 1);
    ...
    var V = function() {
        ...
        c.prototype.print = function(a, b) {
            ...
            for (e = 0; e < c.length; e++) this.Vf(c[e]), this.ea.view.Xd(l, h.x, h.y, h.width, h.height), this.ea.view.aa.ia(l), 0 < e ? n.document.write("<div style='page-break-before:always'>") : n.document.write("<div>"), n.document.write("<img style='width:100%' src='"), n.document.write(k.toDataURL()), n.document.write("'></div>"), l.clearRect(h.x, h.y, h.width, h.height);
        ...
        c.prototype.zxfGetfile = function(type = 'file', needReturn = false) {
            ...
            l.translate(-h.x, -h.y);
            e = window.location.hostname;
            for (e = 0; e < c.length; e++) this.Vf(c[e]), this.ea.view.Xd(l, h.x, h.y, h.width, h.height), this.ea.view.aa.ia(l);
    ...
    V.prototype.zxfGetfile = V.prototype.zxfGetfile;
